...
import { BoardArticle, BoardArticles } from '../../libs/dto/member/board-article/board-article';
import {
	AllBoardArticlesInquiry,
	BoardArticleInput,
	BoardArticlesInquiry,
} from '../../libs/dto/member/board-article/board-article.input';
import { Model, ObjectId } from 'mongoose';
import { Direction, Message } from '../../libs/Errors';
import { BoardArticleStatus } from '../../libs/enums/board-article.enum';
import { ViewGroup } from '../../libs/enums/view.enum';
import { StatisticModifier, T } from '../../libs/types/common';
import { BoardArticleUpdate } from '../../libs/dto/member/board-article/board-article.update';
...
export class BoardArticleService {
	...
	public async getBoardArticle(memberId: ObjectId, articleId: ObjectId): Promise<BoardArticle> {
		...
		if (memberId) {
			...
			targetBoardArticle.meLiked = meLiked ? [meLiked] : undefined;
		}
